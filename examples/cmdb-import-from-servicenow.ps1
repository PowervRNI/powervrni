# PowervRNI Examples
#
# Example: Import Applications from ServiceNow
#
# START Description
# Retrieves applications from the CMDB ServiceNow, and imports them into vRNI.
# Note: is now a native vRNI feature, the script is still here to serve as an example.
# END Description
#
